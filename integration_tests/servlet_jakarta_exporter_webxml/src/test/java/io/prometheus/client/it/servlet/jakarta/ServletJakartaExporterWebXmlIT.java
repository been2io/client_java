...
public class ServletJakartaExporterWebXmlIT {
    ...
    public void testSampleNameFilter() throws IOException, InterruptedException {
        ...
        metrics = scrapeMetrics("requests_count", "requests_sum");
        System.out.println("filtered: " + metrics);
        assertNotContains(metrics, "requests_bucket");
        assertContains(metrics, "requests_count");
        assertContains(metrics, "requests_sum");
        assertNotContains(metrics, "requests_created");
        assertNotContains(metrics, "requests_status_total");
        assertNotContains(metrics, "requests_status_created");
        assertNotContains(metrics, "jvm_gc_collection_seconds_count");
        assertNotContains(metrics, "jvm_threads_deadlocked");
        assertNotContains(metrics, "jvm_memory_pool");
    }
    ...
    private List<String> scrapeMetrics(String... names) throws IOException {
