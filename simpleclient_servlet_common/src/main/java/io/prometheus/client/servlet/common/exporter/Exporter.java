...
public class Exporter {
   ...
   *                         This will be merged with the includedMetricNamePrefixes, excludedMetricNamePrefixes,
   *                         and includedMetricNames from the {@code ServletConfig}.
   *                         sampleNameFilter may be {@code null} indicating that nothing should be filtered by default.
   */
